...
import { IMPTSenditemAvailablereceiversResponse } from "../models/mpt/routes/senditem/availablereceivers/IMPTSenditemAvailablereceiversResponse";
import { MPTConfig } from "../utils/MPTConfig";

@injectable()
export class MPTSendItemController {
    constructor(
    ...
    public sendItem(pmcData: IPmcData, body: IMPTSendItemRequestData, sessionID: string): IItemEventRouterResponse {
        const mptConfig = this.mptConfig.getConfig();
        ...
        if (mptConfig.server.giftedItemsLoseFIR) {
     ...
     * @returns 
     */
    public handleAvailableReceivers(sessionID: string): IMPTSenditemAvailablereceiversResponse {
